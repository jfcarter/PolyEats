...
{
    public string user, buildingNumber, imageNumber, price, roomNumber, orderForPerson;
    ...
    public void polyEatsInfoBase(string user, string buildingNumber, string orderForPerson, string price, string roomNumber)
    {
        this.user = user;
