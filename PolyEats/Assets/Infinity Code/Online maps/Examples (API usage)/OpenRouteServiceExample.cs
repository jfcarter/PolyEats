...
namespace InfinityCode.OnlineMapsExamples
{
    ...
    public class OpenRouteServiceExample : MonoBehaviour
    {
        private void Start()
        {
            ...
            OnlineMapsMarker player = map.GetComponent<Marker_GPS_Example>().GetMarker();
            Vector2 playerPosition = player.position;
            // Looking for pedestrian route between the coordinates.
            OnlineMapsOpenRouteService.Find(playerPosition, new Vector2(8.6828883f, 49.4067577f), "ru", OnlineMapsOpenRouteService.OnlineMapsOpenRouteServicePref.Pedestrian).OnComplete += OnRequestComplete;
        }
